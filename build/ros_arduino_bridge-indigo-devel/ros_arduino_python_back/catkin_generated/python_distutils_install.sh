...
echo_and_run cd "/home/rm/workspace/four_wheel_differential_cal/src/ros_arduino_bridge-indigo-devel/ros_arduino_python_back"
...
echo_and_run /usr/bin/env \
    ...
    "/home/rm/workspace/four_wheel_differential_cal/src/ros_arduino_bridge-indigo-devel/ros_arduino_python_back/setup.py" \
     \
    build --build-base "/home/rm/workspace/four_wheel_differential_cal/build/ros_arduino_bridge-indigo-devel/ros_arduino_python_back" \
    install \
    --root="${DESTDIR-/}" \
